                            ...
                            <div class="bg">
                                <div class="content">
                                    ...
                                    <div class="tip_box">
                                      ...
                                      <ul class="login_m">
                                          <form action="./" name="login" style="margin: 0px; padding: 0px" id="login"  method="POST">
                                              <li>
                                              ...
                                              <li>
                                                  ...
                                                  <input type="submit" onclick="return CheckLogin()" value="" style="float:left;color: rgb(255, 255, 255); background-position: 0px 0px; " onmouseout="this.style.backgroundPosition='0px 0px';" onmouseover="this.style.backgroundPosition='0px -45px';this.style.color='#FFFFFF';" class="login_btn">
...
<script>
    ...
    function CheckLogin(){
        ...
        var ms = "";
        var us = login.username.value, ps = login.password.value, vs = login.validcode_source.value;
        if (!vs.length) {
            ms = v;
        }
        if (vs.length < 4) {
